  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <button 
          onClick={fetchDashboardData}
          className="self-start md:self-auto px-4 py-2.5 bg-brand-50 hover:bg-brand-100 dark:bg-brand-950/30 dark:hover:bg-brand-900/30 text-brand-600 dark:text-brand-400 text-xs font-bold rounded-xl border border-brand-100/50 dark:border-brand-900/50 transition-all flex items-center gap-1.5 shadow-sm"
        >
      ...
      {data.alerts.length > 0 && (
        <div className="bg-gradient-to-l from-amber-50 to-orange-50 dark:from-amber-950/15 dark:to-orange-950/5 border border-amber-250/60 dark:border-amber-900/40 p-5 rounded-2xl space-y-3.5 shadow-sm animate-slide-down">
          <div className="flex items-center gap-2 text-amber-700 dark:text-amber-400">
            ...
            <h3 className="text-sm font-black font-cairo">تنبيهات المدفوعات المستحقة (اقتراب موعد التسليم/التخرج)</h3>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-3">
            {data.alerts.map((alert) => (
              <div 
                key={alert.orderId}
                className="bg-white dark:bg-slate-900/70 border border-amber-200/50 dark:border-amber-900/20 p-3.5 rounded-xl flex flex-col justify-between hover:shadow-md transition-all group relative overflow-hidden"
              >
                <div>
                  <div className="flex items-center justify-between">
                    <span className="text-[11px] font-black text-amber-600 dark:text-amber-500 font-tajawal bg-amber-50 dark:bg-amber-950/30 px-2 py-0.5 rounded-md">
                      {alert.orderNumber}
                    </span>
                  ...
                  <h4 className="text-xs font-black text-slate-800 dark:text-slate-200 mt-2 font-cairo">
                    {alert.customerName}
                  </h4>
                  <div className="flex items-center gap-1 text-[11px] text-slate-500 dark:text-slate-400 mt-1 font-tajawal">
                ...
                <div className="flex items-center justify-between mt-3 pt-2.5 border-t border-slate-100 dark:border-slate-800/60">
                  <span className="text-xs text-red-650 dark:text-red-400 font-black">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800/80 p-5 rounded-2xl shadow-sm flex items-center gap-4 group hover:shadow-md transition-all relative overflow-hidden">
          ...
          <div>
            <p className="text-xs text-slate-400 dark:text-slate-500 font-bold font-tajawal">إجمالي الإيرادات (المحصل)</p>
            <h3 className="text-xl font-black text-slate-800 dark:text-slate-100 font-cairo mt-1">
        ...
        {/* Remaining Payments */}
        <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800/80 p-5 rounded-2xl shadow-sm flex items-center gap-4 group hover:shadow-md transition-all relative overflow-hidden">
          <div className="p-3 bg-red-50 dark:bg-red-950/30 rounded-xl text-red-650 dark:text-red-400 border border-red-100/50 dark:border-red-900/30">
            <DollarSign className="w-6 h-6" />
          </div>
          <div>
            <p className="text-xs text-slate-400 dark:text-slate-500 font-bold font-tajawal">المستحقات المتبقية</p>
            <h3 className="text-xl font-black text-slate-800 dark:text-slate-100 font-cairo mt-1">
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800/80 p-5 rounded-2xl shadow-sm flex items-center gap-4 group hover:shadow-md transition-all">
          ...
          <div>
            <p className="text-xs text-slate-400 dark:text-slate-500 font-bold font-tajawal">إجمالي الطلبات</p>
            <h3 className="text-xl font-black text-slate-800 dark:text-slate-100 font-cairo mt-1">
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800/80 p-5 rounded-2xl shadow-sm flex items-center gap-4 group hover:shadow-md transition-all">
          ...
          <div>
            <p className="text-xs text-slate-400 dark:text-slate-500 font-bold font-tajawal">إجمالي الزبائن</p>
            <h3 className="text-xl font-black text-slate-800 dark:text-slate-100 font-cairo mt-1">
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800/80 p-5 rounded-2xl shadow-sm flex items-center gap-4 group hover:shadow-md transition-all">
          ...
          <div>
            <p className="text-xs text-slate-400 dark:text-slate-500 font-bold font-tajawal">قطع مبيعة</p>
            <h3 className="text-xl font-black text-slate-800 dark:text-slate-100 font-cairo mt-1">
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800/80 p-5 rounded-2xl shadow-sm flex items-center gap-4 group hover:shadow-md transition-all">
          ...
          <div>
            <p className="text-xs text-slate-400 dark:text-slate-500 font-bold font-tajawal">قطع مستأجرة</p>
            <h3 className="text-xl font-black text-slate-800 dark:text-slate-100 font-cairo mt-1">
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800/80 p-5 rounded-2xl shadow-sm flex items-center gap-4 group hover:shadow-md transition-all">
          ...
          <div>
            <p className="text-xs text-slate-400 dark:text-slate-500 font-bold font-tajawal">قطع تم إرجاعها</p>
            <h3 className="text-xl font-black text-slate-800 dark:text-slate-100 font-cairo mt-1">
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800/80 p-5 rounded-2xl shadow-sm flex items-center gap-4 group hover:shadow-md transition-all">
          ...
          <div>
            <p className="text-xs text-slate-400 dark:text-slate-500 font-bold font-tajawal">طلبيات قيد التجهيز / سلمت</p>
            <h3 className="text-sm font-black text-slate-800 dark:text-slate-100 font-cairo mt-1.5 flex gap-1.5">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800/80 p-5 rounded-2xl shadow-sm lg:col-span-2 space-y-4">
          <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800/60 pb-3">
            ...
            <span className="text-xs font-semibold text-slate-400 dark:text-slate-500 font-tajawal">
          ...
          <div className="space-y-4">
            {/* Today */}
            <div>
              <h4 className="text-xs font-bold text-slate-600 dark:text-slate-400 mb-2 flex items-center gap-1.5 bg-slate-50 dark:bg-slate-950/40 p-2 rounded-lg">
                <span className="w-2 h-2 rounded-full bg-brand-500" />
                توصيلات اليوم ({data.todayDeliveries.length})
              </h4>
              {data.todayDeliveries.length === 0 ? (
                <p className="text-xs text-slate-400 dark:text-slate-600 py-3 pr-2 font-tajawal">لا يوجد طلبيات مجدولة للتسليم اليوم.</p>
              ) : (
                <div className="divide-y divide-slate-100 dark:divide-slate-850">
                  {data.todayDeliveries.map((d) => (
                    <div key={d.id} className="py-2.5 flex items-center justify-between text-xs group">
                      <div>
                        <span className="font-bold text-slate-800 dark:text-slate-200">{d.customerName}</span>
                        <span className="mx-2 text-slate-300">/</span>
                        <span className="text-slate-500 font-tajawal">{d.category === 'Other' ? (d.customCategory || 'أخرى') : d.category} (عدد: {d.quantity})</span>
                      </div>
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-[11px] text-slate-400 dark:text-slate-500 font-tajawal">{d.phone}</span>
                      </div>
                    </div>
                  ))}
                </div>
            ...
            <div>
              ...
              {data.tomorrowDeliveries.length === 0 ? (
                <p className="text-xs text-slate-400 dark:text-slate-600 py-3 pr-2 font-tajawal">لا يوجد طلبيات مجدولة للتسليم غداً.</p>
              ) : (
                <div className="divide-y divide-slate-100 dark:divide-slate-850">
        ...
        <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800/80 p-5 rounded-2xl shadow-sm space-y-4">
          ...
          <div className="space-y-4">
            {data.employeeStats.map((emp) => (
              ...
              >
                ...
                <div className="flex items-center justify-between pr-2">
                  <h4 className="text-sm font-black text-slate-800 dark:text-slate-200">الموظف: {emp.name}</h4>
                  <span className="text-[10px] font-bold text-slate-400 dark:text-slate-550 bg-slate-200/50 dark:bg-slate-800/60 px-2 py-0.5 rounded-md">
                ...
                <div className="grid grid-cols-2 gap-2 pr-2">
                  <div>
                    <span className="text-[10px] font-bold text-slate-400 dark:text-slate-500 block font-tajawal">تحصيل الإيرادات</span>
                    <span className="text-xs font-black text-brand-600 dark:text-brand-400 font-cairo">
                      {formatCurrency(emp.revenue)}
                    </span>
                  </div>
                  <div>
                    <span className="text-[10px] font-bold text-slate-400 dark:text-slate-500 block font-tajawal">النسبة من الإجمالي</span>
                    <span className="text-xs font-black text-slate-700 dark:text-slate-300 font-cairo">
                      {data.totalRevenue > 0 
            ...
            <div className="pt-2">
              <h4 className="text-xs font-bold text-slate-700 dark:text-slate-300 mb-2.5">التصنيفات الأكثر طلباً</h4>
              <div className="space-y-2">
                {data.mostSoldProducts.map((prod, idx) => (
                  <div key={idx} className="flex items-center justify-between text-xs">
                    <span className="text-slate-600 dark:text-slate-400 font-semibold">{prod.name}</span>
                    <div className="flex items-center gap-2">
                      ...
                      <span className="font-bold text-slate-700 dark:text-slate-350">{prod.quantity} قطعة</span>
                    </div>
                  </div>
                ))}
                {data.mostSoldProducts.length === 0 && (
                  <p className="text-xs text-slate-400 dark:text-slate-600 font-tajawal">لا يوجد منتجات كافية لعرضها.</p>
                )}
              </div>
            </div>
          ...
          <table className="w-full text-right border-collapse text-xs">
            <thead>
              <tr className="border-b border-slate-100 dark:border-slate-800/80 text-slate-400 dark:text-slate-555">
                ...
                <th className="py-3 px-4 font-bold font-tajawal">الموظف المسؤول</th>
                <th className="py-3 px-4 font-bold font-tajawal">إجمالي القيمة</th>
            ...
            <tbody className="divide-y divide-slate-50 dark:divide-slate-850">
              {data.latestOrders.map((o) => (
                <tr key={o.id} className="hover:bg-slate-50/50 dark:hover:bg-slate-950/20 transition-all">
                  ...
                  <td className="py-3.5 px-4 font-bold text-slate-800 dark:text-slate-200">{o.customerName}</td>
                  <td className="py-3.5 px-4 font-semibold text-slate-500 dark:text-slate-400 font-tajawal">{formatDate(o.orderDate)}</td>
                  <td className="py-3.5 px-4 font-semibold text-slate-650 dark:text-slate-350">{o.employeeName}</td>
                  <td className="py-3.5 px-4 font-black text-slate-800 dark:text-slate-100 font-cairo">{formatCurrency(o.grandTotal)}</td>
                  ...
                  <td className="py-3.5 px-4 font-semibold">
                    <span className={`px-2.5 py-0.5 rounded-full text-[10px] font-bold ${
                      ...
                      'bg-orange-50 dark:bg-orange-950/20 text-orange-650 dark:text-orange-450'
                    }`}>
                  ...
                  <td className="py-3.5 px-4">
                    <button 
                      ...
                      className="px-2.5 py-1 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-300 font-bold rounded-lg text-[10px] transition-all border border-slate-200/20"
                    >
                      فتح
                    </button>
                  </td>
