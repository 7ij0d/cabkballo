            ...
            <table className="w-full text-right border-collapse text-sm">
              <thead>
                <tr className="border-b border-slate-100 dark:border-slate-800 text-slate-400">
                  <th className="py-3.5 px-4 font-bold font-tajawal">التاريخ والوقت</th>
                  <th className="py-3.5 px-4 font-bold font-tajawal">اسم الموظف</th>
                  <th className="py-3.5 px-4 font-bold font-tajawal">الحركة البرمجية</th>
                  <th className="py-3.5 px-4 font-bold font-tajawal">تفاصيل الإجراء المنجز</th>
                </tr>
              </thead>
                ...
                {filteredLogs.map((log) => {
                  ...
                  return (
                    <tr key={log.id} className="hover:bg-slate-50/50 transition-all">
                      <td className="py-4.5 px-4 font-semibold text-slate-500 dark:text-slate-400 font-tajawal">
                        {formatDate(log.createdAt)} - {timeStr}
                      </td>
                      <td className="py-4.5 px-4 font-black text-slate-800 dark:text-slate-200">
                        {log.employeeName}
                      </td>
                      ...
                      <td className="py-4.5 px-4 font-semibold text-slate-600 dark:text-slate-350 leading-relaxed font-tajawal">
                        {log.details}
                      </td>
                    </tr>
                  );
